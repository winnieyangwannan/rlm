...
# =============================================================================
run_id = 513
model_path = "meta-llama/Llama-3.1-8B-Instruct"  # Hugging Face model ID (must match what vLLM is serving)
model_name = "llama"
...
VLLM_HOST = "h200-137-021-252"  # Set via env var or default
VLLM_PORT = "30620" # Set via env var or default
...
def main():
    ...
    rlm = RLM(
        ...
        backend_kwargs={
            ...
            "api_key": "EMPTY",  # vLLM requires a placeholder (use "EMPTY" or any string)
        },
        environment="local",
        environment_kwargs={},
        max_depth=1,
