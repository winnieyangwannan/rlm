...
# =============================================================================
# CWM requires a specific system prompt format for thinking mode to work.
# The model needs to be told to use <think>...</think> tags explicitly.
CWM_SYSTEM_PROMPT = """You are a helpful AI assistant. You always reason before responding, using the following format:
...
For this task, you act as an ANALYSIS AGENT. Your job is to ANALYZE data and code, NOT to modify or fix anything.

You are tasked with answering a query with associated context. You can access, transform, and analyze this context interactively in a REPL environment.
...
⚠️ CRITICAL: YOU ARE AN ANALYSIS AGENT ⚠️
- Your role is to READ, ANALYZE, and REPORT on the data and codebase
- DO NOT attempt to modify, fix, or write new code for the CODEBASE
- DO NOT create new files or save changes to the codebase
- When asked for "recommendations" or "fixes", DESCRIBE what changes could be made - do NOT implement them
- All your code in the REPL should be for ANALYSIS purposes only (e.g., pandas queries, string searches, counting, summarizing)
...
5. **ANALYSIS ONLY**: Only write code to analyze data. Never write code to modify the CODEBASE.
...
⚠️ BEFORE GIVING YOUR FINAL ANSWER:
- Re-read the original question carefully
- Count how many parts/items the question asks for
- Verify your answer addresses EACH numbered item with supporting evidence
- If the question has 4 parts, your answer MUST have 4 corresponding sections
...
"""
    ...
    rlm = RLM(
        ...
        max_depth=2,
        max_iterations=20,  # CWM may need more iterations due to one-block-at-a-time
    ...
    question = """ANALYSIS TASK - Complete ALL 4 sections below. Do NOT skip any section.

⚠️ ANALYSIS ONLY: Do NOT modify codebase/rollout_df. Only READ and ANALYZE.

================================================================================
SECTION 1 of 4: IDENTIFY TOP ERRORS
================================================================================
- Filter rollout_df where valid_submission == False
- Count the top 5 most common eval_error_output messages  
- Print the error messages and their counts

================================================================================
SECTION 2 of 4: DEEP DIVE INTO #1 ERROR
================================================================================
- For the MOST frequent error from Section 1:
- Show 2-3 example code solutions that had this error
- Describe what patterns you see in these failing solutions

================================================================================
SECTION 3 of 4: ROOT CAUSE ANALYSIS
================================================================================
- Search the codebase dict for files related to the #1 error
- Quote relevant code snippets from those files
- Explain the likely root cause

================================================================================
SECTION 4 of 4: RECOMMENDATIONS (describe only, do NOT implement)
================================================================================
- Propose 2-3 fixes that would prevent this error
- Describe (but do NOT code) what changes would help

================================================================================
YOUR FINAL ANSWER MUST HAVE ALL 4 SECTIONS WITH EVIDENCE FROM YOUR ANALYSIS
================================================================================"""
