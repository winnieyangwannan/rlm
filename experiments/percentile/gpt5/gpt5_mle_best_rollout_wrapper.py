"""
Wrapper script to extract best rollout_str for multiple tasks.

This script runs gpt5_mle_best_rollout.py for each task in parallel,
extracting the rollout_str from the rollout with the highest score.
"""
...
def run_single_task(
    ...
    """Run best rollout extraction for a single task.
...
def run_for_tasks(
    ...
    """Run the best rollout extraction script for each task name in parallel.
    
    Args:
        task_names: List of task names to process.
        output_dir: Directory to save output .md files.
        script_path: Path to the best rollout extraction script.
        run_id: Run ID for the analysis.
        max_workers: Number of parallel workers (default: 4).
        model: Model name for file naming (default: gpt5).
        job_name: Job name for file naming (default: rollout).
    """
    ...
    print(f"Extracting best rollout for {len(task_names)} tasks with {max_workers} workers...")
    ...
    print(f"\nBest rollout files saved to: {output_dir}")
...
if __name__ == "__main__":
    ...
    # Configuration
    script_path = "/home/winnieyangwn/rlm/experiments/percentile/gpt5/gpt5_mle_best_rollout.py"

    # Round 1
    task_names = mle_30_r2_7 
    output_dir = "/checkpoint/maui_sft/winnieyangwn/rlm_dumps/best_rollout/mle_30"
    run_id = "514"
    group_name="maui_sft"

    # Round 2
    # task_names = mle_30_r2_7 
    # output_dir = "/checkpoint/agentic-models/winnieyangwn/rlm_dumps/best_rollout/mle_30_r2"
    # run_id = "524_code"
    # group_name="agentic-models"

    # Round 3
    # task_names = mle_30_r2_7 
    # output_dir = "/checkpoint/agentic-models/winnieyangwn/rlm_dumps/best_rollout/mle_30_r3"
